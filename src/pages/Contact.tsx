          ...
          <div className="w-full h-full flex flex-col">
            ...
            >
              <div className="h-full flex flex-col items-center justify-center p-6 md:p-8 lg:p-10">
                <h2 className="font-montserrat font-semibold text-xl md:text-2xl lg:text-3xl mb-8 md:mb-12 text-center" style={{ color: '#5eead4' }}>
                  СВЯЗАТЬСЯ С НАМИ
                </h2>
                  ...
                  {contacts.map((contact) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div>
                          <div className="font-montserrat text-zinc-500 text-[10px] md:text-xs">{contact.label}</div>
                ...
                <p className="font-montserrat text-zinc-500 text-xs md:text-sm text-center mt-8 max-w-md">
