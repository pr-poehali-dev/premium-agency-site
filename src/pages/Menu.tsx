...
const Menu = () => {
  ...
  return (
    <AppLayout>
      ...
      />
      <PageTransition>
        <div className="fixed inset-0 items-center justify-center p-6 hidden lg:flex" style={{ background: 'rgba(0,0,0,0.95)', zIndex: 20000 }}>
          <div 
            className="grid gap-3 w-full max-w-[1600px]" 
            style={{ 
