        ...
        <div className="p-2 sm:p-5 pb-32">
          ...
          >
            <div className="p-4 sm:p-6 md:p-8 lg:p-10">
              <h2 className="font-montserrat font-light text-2xl md:text-3xl lg:text-4xl tracking-wide mb-8 text-center uppercase" style={{ color: '#f97316' }}>
                ДИЗАЙН
              </h2>
                ...
                {designServices.map((service) => (
                  ...
                  >
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        <h3 className="font-montserrat font-semibold text-lg" style={{ color: '#f97316' }}>
                          {service.title}
                        </h3>
