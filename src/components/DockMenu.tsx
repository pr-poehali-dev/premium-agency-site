              ...
              >
                <div className="relative p-3">
                  <div
                    ...
                    style={{
                      background: isHovered ? 'rgba(161,161,170,0.12)' : 'transparent',
                      border: isHovered ? '1px solid rgba(161,161,170,0.25)' : '1px solid transparent',
                      boxShadow: isHovered ? '0 0 20px rgba(161,161,170,0.15), inset 0 1px 0 rgba(255,255,255,0.05)' : 'none',
                    }}
                  />
                  <Icon
                    name={item.icon}
                    ...
                    style={{
                      color: '#eab308',
                      filter: isHovered
                        ? 'drop-shadow(0 0 12px rgba(161,161,170,0.6)) drop-shadow(0 0 30px rgba(161,161,170,0.3))'
